  ...
  return (
    <div className="bg-primary-muted  fixed w-full top-0  z-50  px-5 py-4 flex justify-between items-center gap-3 text-white-base">
      <div className="flex items-center cursor-pointer gap-2">
        ...
        />
        <Link to={"/"}>
          <h1 className=" hidden lg:block text-[18px] lg:text-[25px] font-bold tracking-[1.5px]">
            Soft
            <span className=" text-[20px] text-blue-base lg:text-[28px]">
              x
            </span>
            bd
          </h1>
      ...
      <div
        className={` ${
          active
            ? "w-[90%] lg:w-[50%] overflow-hidden px-5 py-[4px] border border-[#34e4b5]  rounded-full translate-x-0"
            : "w-[0px]  translate-x-10"
        } transition  flex justify-between items-center gap-2   overflow-hidden`}
      >
        <input
          type="search"
          className=" w-full  outline-0 placeholder:text-white-base bg-primary-base px-2 py-1"
      ...
      <div className="flex items-center gap-4 ">
        ...
        <div>
          <img
            ...
            width={50}
            height={50}
            src={"https://i.ibb.co/qBftv7B/DSC-0105-1.png"}
            alt="image"
          />
        </div>
      </div>
