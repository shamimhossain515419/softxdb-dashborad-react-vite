  ...
  return (
    <>
      {active && (
        ...
        >
          <div className=" max-w-[1000px] md:min-w-[600px] xl:min-w-[800px]  min-h-[400px] bg-primary-base p-4 max-h-[80vh]  overflow-y-scroll sidebarScrool  rounded-lg ">
            <div className=" flex justify-between items-center gap-3 pb-6">
              <h1 className='text-[25px] font-medium text-white-base'> {title} </h1>
