...
const Selectitem = ({ CategoryData, title }) => {
    const [activeSelect, setActveSelect] = useState("Select category");
                ...
                <div className="relative ">
                    ...
                    >
                        ...
                        <div className="pt-3 bg-primary-base z-50">
                            <Collapse isOpened={active} className="">
                                <div className=" text-white-muted space-y-[2px] bg-primary-base  ">
                                    {CategoryData?.map((item, index) => {
                                        return (
                                            <div
                                                onClick={() => {
                                                    setActveSelect(item?.value), setActive(false);
                                                }}
                                                key={index}
                                            ...
                                            >
                                                <h1 className="text-[12px]  ">{item?.value}</h1>
                                            </div>
                                        );
                                    })}
                                </div>
