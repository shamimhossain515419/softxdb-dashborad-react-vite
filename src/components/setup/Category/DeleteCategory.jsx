...
import { useRemoveCategoryMutation } from '../../../redux/features/api/category/CategoryApi';

const DeleteCategory = ({ openModal, setOpenModal, refetch }) => {
  const [removeCategory, { data }] =
    useRemoveCategoryMutation();
  const deleteUserHandler = () => {
    removeCategory(openModal?.id);
  };
