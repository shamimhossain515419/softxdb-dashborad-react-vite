  ...
  return (
    <>
      ...
      >
        ...
        <td className="px-6 py-4 whitespace-nowrap"> {credit_limit} </td>
        <td className="px-6 py-4 whitespace-nowrap"> {reference_name} </td>
        <td className="px-6 py-4 whitespace-nowrap"> {reference_phone} </td>
        <td className="px-6 py-4 whitespace-nowrap"> {reference_address} </td>
