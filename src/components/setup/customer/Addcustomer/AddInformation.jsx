            ...
            <div className="">
              <div className="grid  sm:grid-cols-2 lg:grid-cols-3 gap-5">
                ...
                <div className="">
                  <label
                    htmlFor=""
                    className="text-[16px] capitalize font-medium  text-white-base"
                  >
                ...
                <div className="">
                  ...
                  >
                    address <span className="text-blue-base">*</span>
                  </label>
                  <input
                    type="text"
                    {...register('address')}
                ...
                <div className="">
                  <label
                    ...
                    className="text-[16px] capitalize font-medium  text-white-base"
                  >
                    nid <span className="text-blue-base">*</span>
                  </label>
                  <input
                    type="number"
                    {...register('nid')}
                ...
                <div className="">
                  <label
                    ...
                    className="text-[16px] capitalize font-medium  text-white-base"
                  >
                    phone <span className="text-blue-base">*</span>
                  </label>
                  <input
                    type="number"
                    {...register('phone')}
                ...
                <div className="">
                  <label
                    ...
                    className="text-[16px] capitalize font-medium  text-white-base"
                  >
                    credit limit <span className="text-blue-base">*</span>
                  </label>
                  <input
                    type="number"
                ...
                <div className="">
                  <label
                    ...
                    className="text-[16px] capitalize font-medium  text-white-base"
                  >
                    reference name <span className="text-blue-base">*</span>
                  </label>
                  <input
                    type="text"
                ...
                {/* input reference_address  */}
                <div className="">
                  <label
                    htmlFor=""
                    className="text-[16px] capitalize font-medium  text-white-base"
                  >
                    reference address <span className="text-blue-base">*</span>
                  </label>
                  <input
                    type="text"
                ...
                <div className="">
                  <label
                    ...
                    className="text-[16px] capitalize font-medium  text-white-base"
                  >
                    reference phone <span className="text-blue-base">*</span>
                  </label>
                  <input
                    type="number"
                ...
                <div className="">
                  <label
                    ...
                    className="text-[16px] capitalize font-medium  text-white-base"
                  >
                    closing balance <span className="text-blue-base">*</span>
                  </label>
                  <input
                    type="number"
                  ...
                  <div className=" pt-10">
                    <div className=" flex flex-col justify-center items-center gap-4 ">
                      <label htmlFor="file" className=" cursor-pointer">
                        ...
                        <span
                          id=""
                          className="bg-blue-base px-10 py-3 rounded text-white-base text-[16px]"
                        >
                          Upload Photo
                        </span>
                      </label>
        ...
        {!active && (
          <div className="flex justify-end items-center gap-3 mt-10">
            <div className=" flex items-center gap-6">
              ...
              <button type='submit' className="text-[14px] text-white-base  border border-blue-base hover:bg-blue-base duration-300 px-6 py-2 rounded ">
                Save
              </button>
            </div>
          </div>
